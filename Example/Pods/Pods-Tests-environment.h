...
// CHPlaceholder
#define COCOAPODS_POD_AVAILABLE_CHPlaceholder
#define COCOAPODS_VERSION_MAJOR_CHPlaceholder 0
#define COCOAPODS_VERSION_MINOR_CHPlaceholder 1
#define COCOAPODS_VERSION_PATCH_CHPlaceholder 0
